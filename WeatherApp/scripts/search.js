...
// displays 3 day 9am-5pm forecast baased on location entered
function displayWeatherByLocation(position) {
...
inputButton = document.getElementById("search-button");
inputButton.addEventListener("click", displayWeatherByLocation);
